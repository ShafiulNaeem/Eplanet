...
@section('content')
    ...
    <!--slider area start-->
    <section id="sec1" class="slider_section">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="plant1" role="tabpanel">
                                                <div class="product_carousel product_column5 owl-carousel">
                                                    ...
                                                    @foreach($productTops as $products)
                                                        @foreach($products->productsWithTop as $product)
    ...
    <section id="sec2" class="product_capasity">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="product_area ">
...
{{--                                                                                    --}}
{{--                                                                                </a>--}}
                                                                                <img src="{{url('images',$product->capacity_image)}}" alt="{{$product->title}}">
                                                                            </div>
                                                                        </div>
                                                                        <figcaption class="product_content">
                                                                            <h4 class="product_name">{{$product->title}}</h4>
                                                                            <div class="price_box">
                                                                                <p class="current_price">{{$product->description}}</p>
                                                                            </div>
                                                                        </figcaption>
                                                                    </figure>
                                                                </article>
             ...
             <div class="row">
                 <div class="col-md-12">
                     <h3 data-spm-anchor-id="a2700.shop_cp.57252.i0.40d76d1d5XCO82">Production Equipment </h3>
                 </div>
                <div class="col-md-12">
                    <div class="table_content">
                        <table class="table table-bordered" style="background:#EEF8FF;">
   ...
   <!--  quality_control  start  -->
    ...
    <section id="sec3" class="quality_control">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
               ...
               <div class="col-md-3">
                  <div class="litbox-inner">
                      <a id="firstlink" class="venobox" data-gall="gall1" title="Image 1" href="{{url('images',$ProductQuality->quality_image)}}">
                          <img src="{{url('images',$ProductQuality->quality_image)}}" width="150">
                      </a>
                      <div>
                          <h5>{{$ProductQuality->title}}</h5>
                    ...
                    <div class="col-md-3">
                        <div class="litbox-inner">
                            <a id="firstlink" class="venobox" data-gall="gall1" title="Image 1" href="{{url('images',$rnd->rnd_image)}}">
                                <img src="{{url('images',$rnd->rnd_image)}}" alt="{{$rnd->title}}" width="150"></a>
                            <div>
                                <h5>{{$rnd->title}}</h5>
                                <p class="">{{$rnd->description}}</p>
                            </div>
                        </div>
                    </div>
                @endforeach
