...
@section('content')
    ...
    <div class="breadcrumbs_area" style="background-color: #5d6d7e;color:#fff">
        <div class="container">
            <div class="row">
                <div class="col-12">
                        ...
                        <ul style="color: #cfcfcf; font-weight: 600;">
                            ...
                            @foreach ($products as $product)
                                @if ($product->brand_id != null)
                                    <li><a
                                            href="{{ route('brandProduct.show', $product->brand->brand_slug) }}">{{ $product->brand->brand_name }}</a>
                                    </li>
                                @endif
                                @if ($product->category_id != null)
                                    <li><a
                                            href="{{ route('cat.show', $product->category->category_slug) }}">{{ $product->category->category_name }}</a>
                                    </li>
                                @endif
                                @if ($product->sub_categories_id != null)
                                    <li><a
                                            href="{{ route('subcat.show', $product->subcategory->subcategory_slug) }}">{{ $product->subcategory->subcategory_name }}</a>
                                    </li>
                                @endif
                                @if ($product->secondary_sub_categories_id != null)
                                    <li><a
                                            href="{{ route('secondary_sub.show', $product->secondsub->secondary_subcategory_slug) }}">{{ $product->secondsub->secondary_subcategory_name }}</a>
                                    </li>
                                @endif
                ...
                @foreach ($products as $product)
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-5 float-left">
                            <div class="product-details-tab">
                                <div id="img-1" class="zoomWrapper single-zoom">
                                    <a href="#">
                                        <img id="zoom1" src="{{ assetImageAndVideo('images') . $product->feature_image }}"
                                            data-zoom-image="{{ assetImageAndVideo('images') . $product->feature_image }}"
                                    ...
                                    <ul class="s-tab-zoom owl-carousel single-product-active" id="gallery_01">
                                        <li>
                                            <a href="#" class="elevatezoom-gallery active" data-update=""
                                                data-image="{{ assetImageAndVideo('images') . $product->feature_image }}"
                                                data-zoom-image="{{ assetImageAndVideo('images') . $product->feature_image }}">
                                                <img src="{{ assetImageAndVideo('images') . $product->feature_image }}"
                                                    alt="zo-th-1" />
                                            </a>
                                        ...
                                        @foreach ($product->productImages as $images)
                                            <li>
                                                <a href="#" class="elevatezoom-gallery active" data-update=""
                                                    data-image="{{ assetImageAndVideo('images') . $images->product_image }}"
                                                    data-zoom-image="{{ assetImageAndVideo('images') . $images->product_image }}">
                                                    <img src="{{ assetImageAndVideo('images') . $images->product_image }}"
                                                        alt="zo-th-1" />
                                                    <span></span>
                                                </a>
                        ...
                        <div class="col-lg-7 col-md-7 float-left">
                            ...
                            <div class="row">
                                <form role="form" action="{{ route('pages.cart') }}" enctype="multipart/form-data"
                                    method="POST">
                                    <div class="col-md-7 float-left">
                                        <div class="product_d_right">
                                            <div class="product_meta">
                                                <span> <b>Condition :</b>
                                                    @if ($product->is_new == 1) Brand New
                                                    @else Old @endif
                                                </span>
                                            </div>
                                            <div class="product_meta">
                                            ...
                                            @if (!empty($product->coupon))
                                                <div class="product_meta">
                                                    <span> <b>Discount Code:</b>
                                                        {{ $product->coupon->coupon_code }}</span>
                                                </div>
                                            @endif
                                            <div class="product_meta">
                                            ...
                                            <div class=" product_ratting">
                                                <ul>
                                                    <li style="cursor: context-menu;" class="btn btn-success">EMI Available
                                                    </li>

                                                    <li>

                                                        @if (!empty($product->emi_id))
                                                        <span class="badge badge-pill badge-primary">Yes</span> @else
                                                        ...
                                                        <li>
                                                            <select name="emi_choose" id="" class="form-control">
                                                                @for ($i = 0; $i < count($ids); ++$i)
                                                                    ...
                                                                    @if (!empty($emi)) <option
                                                                    value="{{ $emi->id }}">{{ $emi->bank_name }}
                                                                    ({{ $emi->duration }}) </option> @endif
                                                                @endfor
                                                            </select>
                                                        </li>
                                                    @endif
                                                ...
                                                <div class="emi">
                                                    <a id="click_change3">
                                                        <i class="fa fa-2x fa-sort-up"></i> <span data-toggle="collapse"
                                                            href="#collapseExample">More details</span>
                                                    </a>
                                                    <div class="collapse" id="collapseExample">
                                                        <div class="card card-body">
                                                            <img src="{{ asset('emi.png') }}" class="image-fluid"
                                                                alt="emi">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="product_d_right">
                                            ...
                                            <div class="price_box ">
                                                <span class="current_price">BDT
                                                    {{ round($product->product_price) }}</span>
                                            ...
                                            <div class="product_meta">
                                                <span>Category: <a
                                                        href="{{ route('cat.show', $product->category->category_slug) }}">{{ $product->category->category_name }}</a></span>
                                            </div>
                                            <div class=" product_d_action">
                                                <ul>
                                                    @if ($product->status == 1)
                                                        <li><a data-target="{{ $product->id }}" id="add_to_wish_list"
                                                                title="Add to wishlist">+ Add to Wishlist</a></li>
                                                    @endif
                                                    @if ($product->stock <= 0)
                                                        <li><a data-target="{{ $product->id }}" id="express_wish"
                                                                title="Express wish">+ Express wish</a></li>
                                                    @endif

                                                    {{-- @if ($product->admin->role == 2) --}}
                                                    <li>
                                                        <a href="{{ route('topSale.show', $product->admin_id) }}"
                                                            title="Add to wishlist">Vendor Details</a>
                                                    </li>
                                                    {{-- @endif --}}
                                                </ul>
                                            </div>
                                            <div class="priduct_social">
                                                <ul>
                                                    ...
                                                    <li><a class="pinterest" href="#" title="youtube"><i
                                                                class="fa fa-youtube"></i> share</a></li>
                                                </ul>
                                            </div>
                ...
                <div class="product_d_inner">
                    <div class="product_info_button">
                        <ul class="nav nav-tabs" role="tablist">
                            <li>
                                <a data-toggle="tab" class="active  show nav-link override-nav-link" id="click_change"
                                    href="#sheet" role="tab" aria-controls="sheet" aria-selected="false">Specification</a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#reviews" class="nav-link override-nav-link" role="tab"
                                    id="click_change2" aria-controls="reviews" aria-selected="true">Reviews</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12 no-gutter">
                        <h4 class="text-center" style="background:#E6E6E6;padding:10px 0">Related Product</h4>
                    </div>
                </div>
                <div class="row">
                        ...
                        @if (isset($mainRe['category']['products']))
                            <div class="row">
                                <div class="col-md-12 float-left">
                                    <h2 class="float-left">{{ $mainRe['category']['category_name'] }}</h2>
                                </div>
                                                            ...
                                                            <figure>
                                                                <div class="single_banner">
                                                                    <div class="banner_thumb">
                                                                        <a
                                                                            href="{{ route('pages.show', $mainRe['category']['products'][$index]['id']) }}">
                                                                            <img src="{{ assetImageAndVideo('images') . $mainRe['category']['products'][$index]['feature_image'] }}"
                                                                                alt="{{ $mainRe['category']['products'][$index]['product_name'] }}">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <figcaption class="product_content">
                                                                    <h4 class="product_name"><a
                                                                            href="{{ route('pages.show', $mainRe['category']['products'][$index]['id']) }}">{{ $mainRe['category']['products'][$index]['product_name'] }}</a>
                                                                    </h4>
                                                                    <div class="price_box">
