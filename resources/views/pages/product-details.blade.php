                            ...
                            <div class="col-md-7">
                                <div class="product_d_right" style="border-right:1px solid #ededed;">
                                    <div class="product_meta">
                                        <span>Condition: <a href="#">Brand New/Old</a></span>
                                    </div>
                                    <div class="product_meta">
                                        <span>Brand Name: <a href="#">Brand</a></span>
                                    </div>
                                    <div class="product_meta">
                                        <span>Brand Model: <a href="#">MOdel 12pdws</a></span>
                                    </div>
                                    <div class="product_meta">
                                        <span>Available stock: <a href="#">5</a></span>
                                    </div>
                                    <div class="product_meta">
                                        <span>Discount Code: <a href="#">sfdiosdgj</a></span>
                                    </div>
                                     <div class="product_meta">
                                        <span>Product Code: <a href="#">sfdiosdgj</a></span>
                                    </div>
                                     <div class="product_meta">
                                        <span>MPN: <a href="#">sfdiosdgj</a></span>
                                    </div>
                                      <div class="product_meta">
                                    ...
                                    <div class="product_desc">
                                        <h6>Features</h6>
                                        <p> <span style="padding:0 40px 0 0">*</span>Model:Acer mw2</p>
                                        <p> <span style="padding:0 40px 0 0">*</span>Model:Acer mw2</p>
                                        <p> <span style="padding:0 40px 0 0">*</span>Model:Acer mw2</p>
                                        <p> <span style="padding:0 40px 0 0">*</span>Model:Acer mw2</p>
                                        <p> <span style="padding:0 40px 0 0">*</span>Model:Acer mw2</p>
                                    ...
                                    <div class=" product_ratting">
                                        <ul>
                                            ...
                                            <li>
                                                <select name="" id="" class="form-control" >
                                                    <option value="">Brack Name</option>
                                    ...
                                    <div class="product_meta">
                                        <span>Discount Price: <a href="#">2340</a></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-5">
               ...
               <div class="related_pro">
                <div class="col-md-4">
                    <div class="product_img">
                        <img src="{{ asset('frontend/assets/img/artical1.jpg') }}" class="card-img-top" alt="...">
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="product_desc">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus soluta quas nobis recusandae distinctio
                    </div>
                </div>
               </div>
               <div class="related_pro">
