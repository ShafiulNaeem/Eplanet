                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="price_box text-center">
                                                    <a class="float-right" href="{{route('pages.show',$product->products->product_slug)}}">
                                                        <p>Size : {{ $product->products->size }}</p>
                                                    </a>
                                                    <span class="current_price float-left">BDT {{$product->products->product_price}}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
