                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4 float-left">
                                                    ...
                                                    <input type="text" name="stock_quantity" value="{{ old('stock_quantity') }}" required autocomplete="off" class="form-control" id="stock_quantity" placeholder="Stock Quantity">
                                                ...
                                                <div class="form-group col-md-4 float-left">
                                                    ...
                                                    <input type="text" name="emergency_price" value="{{ old('emergency_price') }}" required autocomplete="off" class="form-control" id="emergency_price" placeholder="Emergency Price">
