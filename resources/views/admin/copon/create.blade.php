            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form role="form" action="{{route('copon.store')}}" method="POST">
                            @csrf
                            <div class="box-body">

                                <div class="form-group">
                                    <label for="exampleInputPassword1">Coupon Code</label>
                                    <input type="text" name="coupon_code" require="require" autocomplete="off" class="form-control"  placeholder="Coupon Code">
                                    @error('coupon_code')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="amount" require="require" autocomplete="off" class="form-control"  placeholder="Coupon Amount">
                                    @error('amount')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
